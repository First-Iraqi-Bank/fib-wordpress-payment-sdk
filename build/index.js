...
[...Array(1)].map((e, i) => {
      ...
      const unsubscribe = onPaymentSetup(async () => {
        ...
        if (missingRequiredFields) {
          return {
            ...
            message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please fill in all required fields.', 'fib-payments-gateway')
          };
        }
        ...
        return {
          type: emitResponse.responseTypes.ERROR,
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('There was an error.', 'fib-payments-gateway')
        };
      });
  ...
  window.onload = function () {
    ...
    if (iconElement && settings.icon) {
      ...
      imgElement.style.width = '54px';
      imgElement.style.height = '54px';
